...
const instruction_t instructions[256] = {
	...
	{ "ADD A, C",                   0, 4, add_a_b},                  // 0x81
	{ "ADD A, D",                   0, 4, add_a_b},                  // 0x82
	{ "ADD A, E",                   0, 4, add_a_b},                  // 0x83
	{ "ADD A, H",                   0, 4, add_a_b},                  // 0x84
	{ "ADD A, L",                   0, 4, add_a_b},                  // 0x85
	{ "ADD A, (HL)",                0, 8, add_a_hlp},                     // 0x86
	{ "ADD A",                      0, 4, add_a_b},                     // 0x87
	{ "ADC B",                      0, 4, adc_a_b},                       // 0x88
	{ "ADC C",                      0, 4, adc_a_c},                       // 0x89
	{ "ADC D",                      0, 4, adc_a_d},                       // 0x8a
	{ "ADC E",                      0, 4, adc_a_e},                       // 0x8b
	{ "ADC H",                      0, 4, adc_a_h},                       // 0x8c
	{ "ADC L",                      0, 4, adc_a_l},                       // 0x8d
	{ "ADC (HL)",                   0, 8, adc_a_hlp},                  // 0x8e
	{ "ADC A",                      0, 4, adc_a_a},                       // 0x8f
	...
	{ "JP NZ, 0x%04X",              2, 12, jp_nz_val},            // 0xc2
	{ "JP 0x%04X",                  2, 12, jp_val},                   // 0xc3
	{ "CALL NZ, 0x%04X",            2, 12, call_nz_val},        // 0xc4
	{ "PUSH BC",                    0, 16, push_bc},                   // 0xc5
	{ "ADD A, 0x%02X",              1, 8, add_a_val},             // 0xc6
	{ "RST 0x00",                   0, 16, rst_0x00},                    // 0xc7
	{ "RET Z",                      0, 8, ret_z},                       // 0xc8
	{ "RET",                        0, 8, ret},                           // 0xc9
	{ "JP Z, 0x%04X",               2, 12, jp_z_val},              // 0xca
	{ "CB %02X",                    1, 0, cb_val},                      // 0xcb
	{ "CALL Z, 0x%04X",             2, 12, call_z_val},          // 0xcc
	{ "CALL 0x%04X",                2, 12, call_val},               // 0xcd
	{ "ADC 0x%02X",                 1, 8, adc_a_val},                  // 0xce
	{ "RST 0x08",                   0, 16, rst_0x08},                   // 0xcf
	{ "RET NC",                     0, 8, ret_nc},                     // 0xd0
	{ "POP DE",                     0, 12, pop_de},                     // 0xd1
	{ "JP NC, 0x%04X",              2, 12, jp_nc_val},            // 0xd2
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xd3
	{ "CALL NC, 0x%04X",            2, 12, call_nc_val},        // 0xd4
	{ "PUSH DE",                    0, 16, push_de},                   // 0xd5
	{ "SUB 0x%02X",                 1, 8, sub_val},                  // 0xd6
	{ "RST 0x10",                   0, 16, rst_0x10},                   // 0xd7
	{ "RET C",                      0, 8, ret_c},                       // 0xd8
	{ "RETI",                       0, 8, reti},          // 0xd9
	{ "JP C, 0x%04X",               2, 12, jp_c_val},              // 0xda
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xdb
	{ "CALL C, 0x%04X",             2, 12, call_c_val},          // 0xdc
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xdd
	{ "SBC 0x%02X",                 1, 8, sbc_val},                  // 0xde
	{ "RST 0x18",                   0, 16, rst_0x18},                   // 0xdf
	{ "LD (0xFF00 + 0x%02X), A",    1, 12, ld_add8_a},// 0xe0
	{ "POP HL",                     0, 12, pop_hl},                     // 0xe1
	{ "LD (0xFF00 + C), A",         0, 8, ld_cp_a},      // 0xe2
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xe3
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xe4
	{ "PUSH HL",                    0, 16, push_hl},                   // 0xe5
	{ "AND 0x%02X",                 1, 8, and_val},                  // 0xe6
	{ "RST 0x20",                   0, 16, rst_0x20},                   // 0xe7
	{ "ADD SP,0x%02X",              1, 16, add_sp_val},            // 0xe8
	{ "JP HL",                      0, 4, jp_hl},                       // 0xe9
	{ "LD (0x%04X), A",             2, 16, ld_add16_a},           // 0xea
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xeb
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xec
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xed
	{ "XOR 0x%02X",                 1, 8, xor_val},                  // 0xee
	{ "RST 0x28",                   0, 16, rst_0x28},                   // 0xef
	{ "LD A, (0xFF00 + 0x%02X)",    1, 12, ld_a_add8},// 0xf0
	{ "POP AF",                     0, 12, pop_af},                     // 0xf1
	{ "LD A, (0xFF00 + C)",         0, 8, ld_a_cp},      // 0xf2
	{ "DI",                         0, 4, di},                        // 0xf3
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xf4
	{ "PUSH AF",                    0, 16, push_af},                   // 0xf5
	{ "OR 0x%02X",                  1, 8, or_val},                    // 0xf6
	{ "RST 0x30",                   0, 16, rst_0x30},                   // 0xf7
	{ "LD HL, SP+0x%02X",           1, 12, ld_hl_spn},       // 0xf8
	{ "LD SP, HL",                  0, 8, ld_sp_hl},                // 0xf9
	{ "LD A, (0x%04X)",             2, 16, ld_a_add16},           // 0xfa
	{ "EI",                         0, 4, ei},                             // 0xfb
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xfc
	{ "UNKNOWN",                    0, 0, unknown},                 // 0xfd
	{ "CP 0x%02X",                  1, 8, cp_val},                    // 0xfe
	{ "RST 0x38",                   0, 16, rst_0x38},               // 0xff
};
